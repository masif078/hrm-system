...
@section('title', 'Define Salary Structure')
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="mb-1">Define Salary Structure</h3>
                    <p class="text-muted mb-0">Set up salary, allowances, and deductions for an employee.</p>
                </div>
        ...
        <div class="row">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="basic_salary" id="basic_salary" class="form-control calc-trigger @error('basic_salary') is-invalid @enderror" value="{{ old('basic_salary') }}" required>
                            @error('basic_salary')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="house_allowance" id="house_allowance" class="form-control calc-trigger" value="{{ old('house_allowance', 0) }}">
                        </div>

                        <div class="mb-3">
                            <label for="medical_allowance" class="form-label">Medical Allowance</label>
                            <input type="number" step="0.01" name="medical_allowance" id="medical_allowance" class="form-control calc-trigger" value="{{ old('medical_allowance', 0) }}">
                        </div>

                        <div class="mb-3">
                            <label for="transport_allowance" class="form-label">Transport Allowance</label>
                            <input type="number" step="0.01" name="transport_allowance" id="transport_allowance" class="form-control calc-trigger" value="{{ old('transport_allowance', 0) }}">
                        </div>

                        <div class="mb-3">
                            <label for="other_allowance" class="form-label">Other Allowance</label>
                            <input type="number" step="0.01" name="other_allowance" id="other_allowance" class="form-control calc-trigger" value="{{ old('other_allowance', 0) }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="tax" id="tax" class="form-control calc-trigger" value="{{ old('tax', 0) }}">
                        </div>

                        <div class="mb-3">
                            <label for="provident_fund" class="form-label">Provident Fund (PF)</label>
                            <input type="number" step="0.01" name="provident_fund" id="provident_fund" class="form-control calc-trigger" value="{{ old('provident_fund', 0) }}">
                        </div>

                        <div class="mb-3">
                            <label for="other_deduction" class="form-label">Other Deduction</label>
                            <input type="number" step="0.01" name="other_deduction" id="other_deduction" class="form-control calc-trigger" value="{{ old('other_deduction', 0) }}">
                        </div>

                        <div class="mb-3">
                            <label for="effective_from" class="form-label">Effective From <span class="text-danger">*</span></label>
                            <input type="date" name="effective_from" id="effective_from" class="form-control @error('effective_from') is-invalid @enderror" value="{{ old('effective_from') }}" required>
                ...
                <div class="d-grid mb-4">
                    <button type="submit" class="btn btn-primary btn-lg">Save Salary Structure</button>
                </div>
            </div>
        </div>
    </form>
