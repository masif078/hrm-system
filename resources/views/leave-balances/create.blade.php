    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="mb-1">Allocate Leaves</h3>
                    <p class="text-muted mb-0">Define allowed leaves for a specific category and employee.</p>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('leave-balances.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="allocated" id="allocated" class="form-control" min="0" value="{{ old('allocated', 10) }}" required>
                        </div>
