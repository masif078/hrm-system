...
<div class="container-fluid">
    <div class="mb-4">
        <h3 class="fw-bold text-dark">Edit Asset</h3>
        <p class="text-muted">Modify company asset details and warranty values.</p>
    </div>
            ...
            <form action="{{ route('assets.update', $asset->id) }}" method="POST">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="serial_number" id="serial_number" class="form-control @error('serial_number') is-invalid @enderror" value="{{ old('serial_number', $asset->serial_number) }}" required>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" name="cost" id="cost" min="0" step="0.01" class="form-control @error('cost') is-invalid @enderror" value="{{ old('cost', $asset->cost) }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="warranty_expiry" id="warranty_expiry" class="form-control @error('warranty_expiry') is-invalid @enderror" value="{{ old('warranty_expiry', $asset->warranty_expiry) }}">
