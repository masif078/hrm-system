...
<a href="{{ $link }}" class="card border-0 shadow-sm rounded-3 p-2.5 text-decoration-none transition-all quick-action-card d-block h-100" style="background-color: {{ $colorConfig['bg'] }};">
